<?php
    ...
    $sql = "SELECT nom from emplacement WHERE id_emplacement = '$id_emplacement'";
    $result = mysqli_query($conn, $sql);
    $emplacement = mysqli_fetch_assoc($result);
    ...
    if ($result) {
        ...
        echo json_encode(["counter" => $counter_modif, "emplacement" => $emplacement]);
    } else {
